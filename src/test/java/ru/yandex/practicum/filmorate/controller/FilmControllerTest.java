...
//
//        Optional<Film> filmOptional = Optional.ofNullable(filmStorage.filmAdd(newFilm));
//        assertThat(filmOptional)
//                .isPresent()
//                .hasValueSatisfying(film -> {
//                            assertThat(film).hasFieldOrPropertyWithValue("film_id", 8L);
//                            assertThat(film).hasFieldOrPropertyWithValue("film_name", "film8");
...
//                            assertThat(film.getMpa()).hasFieldOrPropertyWithValue("film_id", 1L);
//                        }
//                );
//
//    }
